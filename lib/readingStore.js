...
//    provider notification. No other path may set paid=true.
...
/**
 * Record the provider invoice id + WhatsApp number captured at payment intent, and
 * WHICH SKU was sold.
 *
 ...
 * once-only side effects (WA send) exactly once even if the provider double-fires.
 */
