 ...
 *
 * IT UN-MEETS PRECONDITION 3a. The pooled floor goes back to roughly 20%, and 3a's
 * threshold - ruled the same day - is at or below 10%. THAT COLLISION IS REAL,
 * IT IS RECORDED IN PROGRESS.md (RULED 2026-08-22, the collision section), AND IT
 * IS NOT RESOLVED HERE. Moving the threshold to fit the budget is Reyner's call and
 * nobody else's; a session that quietly widened 3a to keep it green would have
 * turned a gate into a formality. The number that changed is this one.
 */
