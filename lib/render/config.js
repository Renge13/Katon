 ...
 *
 * 2 SINCE 2026-08-19, and the number came from two artifacts rather than a guess:
 * `docs/qa/2026-08-18-retry-depth.md` for the floor curve (18% at one
 * regeneration, 3% at two, and depth 3 bought ZERO further points on that trace)
 * and `docs/qa/2026-08-19-retry-erosion.md` for what the second regeneration
 * costs the prose. Erosion past depth 2 has never been measured.
 */
