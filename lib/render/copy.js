...
export const RENDER_COPY = {
  ...
  /**
   * The two documents' product names. RULED 2026-09-22 (Reyner, P2 markup A1:
   * `ok ("Edisi Lengkap" / "Bacaan Kompatibilitas")`). They print as the cover
   * eyebrow and in the running footer (B2, `Katon - <name>`), and nowhere else.
   * Here rather than in the composers for this file's own reason: this bank is
   * swept by `check:copy`, a literal inside a React tree is not.
   */
  pdfEditionMirror: 'Edisi Lengkap',
  pdfEditionCompat: 'Bacaan Kompatibilitas',
};
