...
export const CARD_TOKENS = {
  ...
  //
  // STILL `approved: false`. This fixed the CARD's contrast, not the TOKEN's
  // approval — the triple is Reyner's to rule and he has not ruled it.
  '戊': { field: '#4A3A1E', ink: '#FAF4E9', accent: '#E3CFA8', approved: false }, // Gunung
