 ...
 *
 * ── 1.35.0: THE v2 JUDGE RUBRIC (2026-09-26) ───────────────────
 * Prompt AD Job B, amendment 1 item 5 (Reyner's B9, C4, C5, C6). One shared call,
 * so every edit is also an edit to what the GATING class reads: J1 gains the scene
 * boundary (an illustration framed as possible or typical passes; a claimed past
 * event or an ungiven chart fact does not), J2 flags only an invented chart cause,
 * J3 is narrowed to rule 25, J4 is removed. J1 decides serve-or-regenerate, so the
 * accept boundary moves. Recalibrated on the final prompt:
 * docs/qa/2026-09-26-voice-v2-j1-recalibration.md. v1 never calls the judge.
 */
export const STAGE6_VERSION = '1.35.0';
