 ...
 *
 * ── 1.26.0-1.38.0 ARE SPENT ON `feat/voice-v2` ─────────────
 * That branch forked at 1.25.0 and numbered its own gate changes 1.26.0-1.38.0
 * (the v2 gate and judge). Reusing any of them here would stamp two different
 * gates with one version, so main continues at 1.39.0.
 *
 ...
 */
export const STAGE6_VERSION = '1.40.0';
