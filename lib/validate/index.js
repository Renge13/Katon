 ...
 *
 * ── 1.39.0: THE v2 JUDGE RUBRIC, WITH J1 PRECEDENCE (2026-09-26) ─
 * Prompt AD Job B, amendment 1 item 5 + amendment 2 item 1 (Reyner's B9, C4, C5,
 * C6; Cowork's precedence line). J1 gains the scene boundary; J2 is only a link the
 * engine does not make between SUPPLIED facts - an invented chart fact used as a
 * cause is J1; J3 is rule 25 only; J4 is removed. The 1.35.0 attempt without the
 * precedence line failed on Pro (side branch 38a7a2c). Adopted only on a full pass
 * of the Flash-lite arms calibration, same doc as 1.38.0.
 */
export const STAGE6_VERSION = '1.39.0';
