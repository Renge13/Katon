 ...
 *
 * ── 1.39.0-1.41.0 ARE MAIN'S (Prompt AG item 1, the pair-truth checks) ──
 * Numbered on main above this branch's range so no version means two gates. They
 * arrive here when main is merged in; this branch does not stamp them.
 *
 ...
 */
export const STAGE6_VERSION = '1.42.0';
