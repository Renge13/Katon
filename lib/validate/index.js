 ...
 */
export const STAGE6_VERSION = '1.16.0';
...
export function validateRendering(rendered, semanticJson, { provider = 'gemini' } = {}) {
  ...
  const { rendered: normalized, inserts } = insertBrackets(structured, semanticJson);
  ...
  const findings = [
    ...
    ...bracketGuard(semanticJson, renderedProse(normalized), metrics, inserts),
