// ============================================================
// lib/validate/judge.js — the voice-v2 reviewer, judge half (J1-J3; J4 removed 1.35.0)
// ============================================================
...
//
// ── 1.35.0: THE RUBRIC CHANGE (Prompt AD Job B, amendment 1 item 5, 2026-09-26) ──
...
// final combined prompt (docs/qa/2026-09-26-voice-v2-j1-recalibration.md).
//
...
// in 1.35.0. A finding is the spec's five fields again.
//
...
//   (c) [J4 removed in 1.35.0] J4 only over the render's own required points: a J4 whose `sentence` is
...
//   (e) the judge runs on the strongest Gemini model on the account, the writer
//       model unchanged. `gemini-pro-latest` resolved to `gemini-3.1-pro-preview`
//       on 2026-09-24 (GET models + a generateContent's modelVersion); the id is
//       pinned rather than the alias, so a silent alias move cannot change the judge.
// ============================================================

const ENDPOINT = 'https://generativelanguage.googleapis.com/v1beta/models';

/** (e) The judge's model. The writer's stays in lib/render/config.js. */
...
// J4 (meaning coverage) is GONE since 1.35.0: Prompt AD Job B, C6 (Reyner:
