 ...
 * 2026-08-11: order is a function of the chart (rule 14). The declaration lives
 * with fact emission in facts.js#ACTIONABLE_KINDS, because what a fact IS is a
 * Phase 1 question; this file only decides what it is WORTH.
 *
 * An unlisted kind scores 0. A new fact kind that should be actionable has to
 * say so, which is the safe direction: silence cannot promote anything.
 */
