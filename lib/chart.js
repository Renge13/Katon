...
export function computeChartInputs({ birthDate, birthTime = null, termSide = null, gender = null }) {
  const chart = calculateBaziChart({ birthDate, birthTime, termSide, gender });
  return {
