...
// decision**, and that decision (migrate / terminate / stay) was made on the
// funnel's purchase data. **It is TAKEN: Reyner terminated on 2026-09-18 and the
// adapter is deleted** - see the INTERIM REGISTER row `XENDIT PRICING CHANGES
// 2026-10-01` in docs/PROGRESS.md, which stays open until his closure
// confirmation is in hand. The paragraph above is kept as the reason this file
// was built first, not as a live question.
//
