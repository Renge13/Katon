...
// QA is a curl. NOTE THE HOST: the apex 308-redirects to www, and a redirect is
// the one place a header can quietly go missing depending on the client. Use the
// canonical host directly (verified against production 2026-08-07:
// `curl -sD - https://katon.app/api/mirror` returns
// `Location: https://www.katon.app/api/mirror`).
//
//   curl -H "x-mirror-preview-token: $MIRROR_PREVIEW_TOKEN" \
//        https://www.katon.app/api/mirror/<token>
//
