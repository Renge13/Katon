...
export const SITE_COPY = register('SITE_COPY', {
  ...
  privasi: {
    ...
    privasi_email: 'Untuk Bacaan Kompatibilitas, kami menyimpan alamat email yang kamu isi. Fungsinya satu: membuka kembali bacaan kalau tautannya hilang. Kami tidak mengirim apa pun ke alamat itu dan tidak membagikannya.',
    privasi_second_person: 'Bacaan Kompatibilitas memakai tanggal lahir orang kedua yang kamu masukkan. Data itu disimpan hanya bersama bacaan tersebut, tidak menghasilkan bacaan terpisah untuk orang itu, dan ikut terhapus kalau kamu meminta bacaannya dihapus.',
  ...
  home_compat_sub: 'Dinamika antara kamu dan satu orang, dibaca dari dua tanggal lahir.',
});
...
export const PASANGAN_COPY = register('PASANGAN_COPY', {
   ...
   */
  page_lead: 'Bacaan personal tentang bagaimana dua pola kalian bertemu: tarikan, gesekan, unsur yang saling mengisi, ritme sehari-hari, dan dinamika keseluruhan di antara kalian.',
  ...
  includes_1: 'Inti diri kalian berdua, dan bagaimana keduanya berhubungan',
  includes_2: 'Kursi pasangan di bagan masing-masing, dan apa yang terjadi saat keduanya bertemu',
  includes_3: 'Unsur yang kalian bawa untuk satu sama lain',
  includes_4: 'Pola hubungan kalian: Cermin, Serumpun, atau Kontras',
  includes_5: 'Kuadran tarikan dan ritme, ditutup dengan peta: yang menguatkan, yang bergesek, dan yang dituntut dari masing-masing',
  price_note: 'Sekali bayar. Bacaan tersimpan di satu tautan yang bisa kamu buka kapan saja.',
   ...
   */
  form_email_help: 'Dipakai untuk membuka kembali bacaan ini kalau tautannya hilang. Tidak ada yang dikirim ke email ini.',
   ...
   * a pronoun swap.
   */
  season_gate_b_intro: 'Tanggal lahir dia jatuh tepat di hari pergantian musim. Jawab sebisamu; kalau tidak yakin, tanyakan langsung padanya.',

  // ── after payment ──
  pending_title: 'Menunggu konfirmasi pembayaran',
  pending_body: 'Halaman ini berganti sendiri begitu pembayaran masuk. Tidak perlu dimuat ulang.',
  paid_title: 'Bacaan kalian sudah siap',
  /** The link IS the access: there is no account and nothing is emailed. */
  link_keep: 'Simpan tautan halaman ini. Tautan ini satu-satunya jalan masuk ke bacaan kalian: tidak ada akun, dan tidak ada yang dikirim ke email.',
  /** Returning to a pair that was created but never paid for. */
  unpaid_resume: 'Bacaan ini belum dibayar. Lanjutkan pembayaran untuk membukanya.',

  // ── the report ──
  // Eyebrows over the two blocks that carry a glossary NAME - the P4 pattern
  // badge and the P5 quadrant. The names themselves are the glossary's
  // (kompatibilitas.p4_*.name_id, p5_q*.name_id) and are never strings here.
  report_badge_eyebrow: 'Pola hubungan',
  report_quadrant_eyebrow: 'Tarikan dan ritme',
