...
export const SITE_COPY = register('SITE_COPY', {
  ...
  // ── THE FRONT DOOR'S TWO PATHS, 2026-09-08 ────────────────
  // Mirror (understand yourself, free) and Compatibility (the dynamic between
  // two people, paid). Ruled 2026-09-07: neither is a prerequisite for the
  // other. These four live in SITE_COPY rather than in PASANGAN_COPY so that
  ...
  home_mirror_label: 'Bacaan Diri',
  home_mirror_sub: 'Pahami polamu sendiri. Gratis.',
  home_compat_label: 'Kompatibilitas',
  home_compat_sub: 'Dinamika dua orang, dibaca dari dua tanggal lahir.',
});
