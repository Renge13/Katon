...
export const SITE_COPY = register('SITE_COPY', {
  ...
  privasi: {
    ...
    privasi_email: 'Alamat email disimpan hanya untuk mengakses kembali bacaan jika tautan hilang. Kami tidak pernah mengirim pesan ke email tersebut atau membagikannya.',
...
export const PASANGAN_COPY = register('PASANGAN_COPY', {
   ...
   */
  page_lead: 'Bacaan personal tentang bagaimana dua pola bertemu: tarikan, gesekan, unsur penyeimbang, ritme harian, dan dinamika hubungan kalian.',
   ...
   */
  form_email_help: 'Hanya dipakai untuk membuka kembali bacaan jika tautan hilang. Tidak ada email yang dikirim.',
  ...
  report_quadrant_eyebrow: 'Tarikan & Ritme',
