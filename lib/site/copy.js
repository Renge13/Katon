...
export const SITE_COPY = {
  ...
  harga: {
    meta: {
      ...
      // `Compatibility Reading` is back in it too - it is still priced-but-unbuilt
      // and the row on the page still says so, which is the same state the sentence
      // described when Reyner approved it.
      description:
  ...
  tentang: {
    ...
    paragraphs: [
      ...
      // `harga.free.body`. FLAGGED FOR REYNER: this is the only /tentang wording in
      // this commit he has not approved in this exact form.
      'Cara pakainya sederhana. Isi tanggal lahir, tambahkan jam lahir kalau kamu mengingatnya. Bacaanmu muncul gratis dan lengkap. Complete Edition berbayar, kartu resolusi tinggi dan PDF dari bacaanmu, bisa kamu ambil atau lewati. Compatibility Reading untuk dua orang sedang disiapkan.',
    ],
  ...
  syarat: {
    ...
    paid: [
      ...
      // added, nothing else in the paragraph touched. FLAGGED FOR REYNER: the added
      // clause is not a restore of an earlier approved string.
