...
export const SITE_COPY = {
  ...
  harga: {
    meta: {
      ...
      description:
        'Bacaan personal dari tanggal lahirmu, gratis. Bacaan Mendalam berbayar bisa kamu ambil atau lewati.',
    },
    title: 'Harga',
    ...
    lead: 'Bacaan pertamamu gratis. Bacaan Mendalam dibuka sekali bayar, tanpa langganan.',
    ...
    free: {
      ...
      body: 'Bacaan personal dari tanggal lahirmu. Tidak perlu akun dan tidak perlu bayar.',
    },
    ...
    artifact: {
      ...
      name: 'Bacaan Mendalam',
      body: 'Menelusuri polamu lebih dalam di hubungan, karier, atau uang. Sekali baca, milikmu selamanya.',
  ...
  tentang: {
    ...
    paragraphs: [
      ...
      'Cara pakainya sederhana. Isi tanggal lahir, tambahkan jam lahir kalau kamu mengingatnya. Bacaanmu muncul gratis. Bacaan Mendalam berbayar bisa kamu ambil atau lewati. Compatibility Reading untuk dua orang sedang disiapkan.',
    ],
   ...
   *   `lib/readingStore.js` setInvoice adds invoice id and sku.
   * - wa_number is NO LONGER collected at checkout (2026-08-13): the checkout
   *   step that asked for it was removed and `app/api/pay/[id]/route.js` no
   *   longer requires it, so no live path writes that column. The only path that
   *   still stores a WhatsApp number is the coming-soon demand capture, which
   *   writes `interest_wa` (readingStore.js#setInterest, reached from
   *   `app/api/reading/[id]/interest/route.js`). That is what the collect and
   *   retention lines below now describe, and it is the whole of it.
  ...
  privasi: {
    ...
    collect: [
      ...
      'Nomor WhatsApp, hanya kalau kamu sendiri meninggalkannya untuk dikabari saat sebuah bacaan baru siap. Pembelian tidak meminta nomor.',
    ...
    retention: [
      ...
      'Nomor WhatsApp: sampai kami mengabarimu soal bacaan yang kamu tunggu, atau sampai kamu meminta penghapusannya.',
  ...
  syarat: {
    ...
    paid: [
      ...
      'Setelah dikonfirmasi, produkmu langsung terbuka di tautan bacaanmu, di halaman yang sama tempat kamu membayar. Simpan tautan itu, karena Katon berjalan tanpa akun dan tautan itulah satu-satunya cara membukanya lagi.',
