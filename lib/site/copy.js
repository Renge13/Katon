...
export const SITE_COPY = {
  ...
  pengembalian: {
    ...
    eligibleNote:
      'Untuk tiga keadaan pertama, kami coba perbaiki dan kirim ulang lebih dulu. Kalau perbaikannya gagal, dananya kami kembalikan penuh.',
    ...
    notEligible: [
      ...
      'Produk yang sudah kamu terima dan bisa kamu buka, lalu diminta kembali setelah lewat 7 hari.',
    ],

    howHeading: 'Cara mengajukan',
    howLead: 'Ajukan paling lambat 7 hari setelah pembayaran. Kirim email dan sertakan tiga hal:',
    how: [
    ...
    reply: [
      'Kami menjawab paling lama 3x24 jam kerja setelah emailmu masuk.',
