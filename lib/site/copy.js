...
export const SITE_COPY = register('SITE_COPY', {
  ...
  //
  // UNRULED: AA §4 leaves this cell to Reyner (delegated to Cowork 2026-09-24),
  // and the committed prompt carries no value for it. So it ships as a PENDING()
  // sentinel and `check-unruled-copy` REFUSES a production build until it is ruled;
  // a preview build passes so it can be seen in place. AA §3's proposal, flagged
  // and NOT adopted: `Baca kecocokan berdua`.
  home_compat_link: PENDING('home_compat_link'),
