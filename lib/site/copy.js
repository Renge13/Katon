...
export const SITE_COPY = register('SITE_COPY', {
  ...
  privasi: {
    ...
    privasi_email: PENDING('pasangan_privasi_email'),
    privasi_second_person: PENDING('pasangan_privasi_second_person'),
  ...
  home_mirror_label: PENDING('pasangan_home_mirror_label'),
  home_mirror_sub: PENDING('pasangan_home_mirror_sub'),
  home_compat_label: PENDING('pasangan_home_compat_label'),
  home_compat_sub: PENDING('pasangan_home_compat_sub'),
});
...
export const PASANGAN_COPY = register('PASANGAN_COPY', {
  // ── the product block ──
  page_title: PENDING('pasangan_page_title'),
  /**
   ...
   */
  page_lead: PENDING('pasangan_page_lead'),
  ...
  includes_1: PENDING('pasangan_includes_1'),
  includes_2: PENDING('pasangan_includes_2'),
  includes_3: PENDING('pasangan_includes_3'),
  includes_4: PENDING('pasangan_includes_4'),
  includes_5: PENDING('pasangan_includes_5'),
  price_note: PENDING('pasangan_price_note'),

  // ── the form ──
  form_a_legend: PENDING('pasangan_form_a_legend'),
  form_b_legend: PENDING('pasangan_form_b_legend'),
  form_email_label: PENDING('pasangan_form_email_label'),
  /**
   ...
   */
  form_email_help: PENDING('pasangan_form_email_help'),
  form_submit: PENDING('pasangan_form_submit'),
  /**
   ...
   * a pronoun swap.
   */
  season_gate_b_intro: PENDING('pasangan_season_gate_b_intro'),

  // ── after payment ──
  pending_title: PENDING('pasangan_pending_title'),
  pending_body: PENDING('pasangan_pending_body'),
  paid_title: PENDING('pasangan_paid_title'),
  /** The link IS the access: there is no account and nothing is emailed. */
  link_keep: PENDING('pasangan_link_keep'),
  /** Returning to a pair that was created but never paid for. */
  unpaid_resume: PENDING('pasangan_unpaid_resume'),
  ...
  report_badge_eyebrow: PENDING('pasangan_report_badge_eyebrow'),
  report_quadrant_eyebrow: PENDING('pasangan_report_quadrant_eyebrow'),
  notfound_title: PENDING('pasangan_notfound_title'),
});
