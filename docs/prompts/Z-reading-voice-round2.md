...
> **Superseded 2026-09-26 by row B26 (voice work is launch-critical; see rulings file)** `docs/content/voice-constraint-rulings-2026-09-26.md`: B26 removes/replaces the required "Hubungan ini meminta kamu untuk ..." closing (no structurally required homework). The live `compat-renderer-prompt.txt` is unchanged until that work lands.
