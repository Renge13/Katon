...
> **SUPERSEDED 2026-09-26 (Reyner), POST-LAUNCH:** `docs/content/voice-constraint-rulings-2026-09-26.md` row B26 removes/replaces the required "Hubungan ini meminta kamu untuk ..." closing (no structurally required homework). The live `compat-renderer-prompt.txt` is unchanged until that post-launch work lands.
