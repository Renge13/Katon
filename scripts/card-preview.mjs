...
<p>Generated by <code>npm run preview:cards</code>. Card A is the free shareable and IS the export:
1080x1350 (4:5), full-bleed, opaque, square corners, no mat. Card B is a 907x1747 object on a
1080x1920 canvas at a uniform 86.4 margin. Both are shown scaled; every dimension in the markup is
the real export pixel size.</p>
