...
// ── 1.35.0 (Prompt AD Job B, amendment 1 item 5): J4 removed; rubric narrowed ──
test('J4 IS GONE (1.35.0): a J4 the model returns anyway is malformed, never a finding', async () => {
  const sj = v2();
...
test('THE JUDGE NO LONGER RECEIVES required_points (1.35.0)', async () => {
  const sj = v2();
  let sent = null;
  globalThis.fetch = async (_url, opts) => {
...
test('THE RUBRIC (1.35.0): J1 has the scene boundary, J2 only chart causes, J3 only rule 25, no J4', () => {
